...
<div class="bg-cover bg-center w-full h-screen" style="background-image: url('{bgspace}')">
    ...
    <div class="mt-32 flex justify-center items-center">
        <div class="p-16 max-w-2xl bg-white bg-opacity-70 rounded-3xl shadow-2xl dark:bg-gray-800 dark:border-gray-700">
            ...
            <p class="mb-8 font-normal text-xl text-gray-800 dark:text-gray-700"><span class="font-bold">Your mission </span>i _ s to conduct a life cycle assessment of the entire environmental management system (EMS) of your company with the aim of reaching net zero carbon emission reduction goals.</p>
