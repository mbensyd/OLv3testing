<script>
    ...
    //const beta = urlTest.url.searchParams.get('beta')
    import { page } from '$app/stores';

    let pageID = $page.params;
    ...
    //var pageID = JSON.parse(params.actor);
</script>
...
<div class="bg-cover bg-center w-full h-screen" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0)), url(src/static/mission-image.png)">
    <nav class="pt-4">
    ...
    <div class="mt-32 flex justify-center items-center">
        <div class="p-16 max-w-2xl bg-white bg-opacity-70 rounded-3xl shadow-2xl dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-8 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Hey, <span class="font-normal">me</span></h5>
