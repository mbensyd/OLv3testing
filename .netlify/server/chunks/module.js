const modules = [
  {
    ...
    image: "src/static/mod1.png",
    toDoList: [
      {
        text: "Task 1: Find some fish",
        status: true
      },
      {
        text: "Task 2: Eat some fish",
        status: false
      },
      {
        text: "Portfolio 1: Make a fishy",
        status: false
      }
    ]
  },
  {
    ...
    image: "src/static/mod2.png"
  },
  {
    Title: "Selecting a Genetic Transformation Method",
    Description: "Learn the basic concepts of green supply chains and environmental management systems, including life cycle assessment.",
    image: "src/static/mod3.png"
  }
];
export {
  modules as m
